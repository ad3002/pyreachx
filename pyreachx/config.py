...
class AnalyzerConfig:
    ...
    def merge(self, other: 'AnalyzerConfig') -> 'AnalyzerConfig':
        return AnalyzerConfig(
            ...
            confidence_threshold=min(self.confidence_threshold, other.confidence_threshold),
            ignore_decorators=list(set(self.ignore_decorators + other.ignore_decorators))
        )