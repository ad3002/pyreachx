...
def test_main_with_options(mock_reporter, mock_config, mock_analyzer):
    ...
    with runner.isolated_filesystem():
        ...
        mock_analyzer.return_value.analyze.assert_called_once_with('project_path', 'module.function')
        
        # Verify reporter was created and used correctly
        mock_reporter.assert_called_once_with(mock_analyzer.return_value.analyze.return_value)
        mock_reporter.return_value.generate_report.assert_called_once_with('report.html')
