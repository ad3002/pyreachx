...
"""
    ...
    assert analyzer._get_callee_name(calls[2]) == "undefined_method"  # Should fall back to method name
    
    # Test chained call to undefined method
    assert analyzer._get_callee_name(calls[3]) == "undefined_method"  # Should fall back to method name
